package com.carincho.springboot.webflux.app.handler;
...
public class ProductoHandler {
	...
	public Mono<ServerResponse>listar(ServerRequest request) {
		...
		return ServerResponse.ok()
				...
				.body(service.findAll(), Producto.class);//Cuando se retorna un tipo reactivo como segundo argumento ´poner el tipo de objeto reactivo
